...
public class _20191023_3 {
	 ...
	 * 
	 * [제한사항] array의 길이는 1 이상 100 이하입니다. array의 각 원소는 1 이상 100 이하입니다. commands의 길이는
	 * 1 이상 50 이하입니다. commands의 각 원소는 길이가 3입니다.
	 */
	public static void main(String[] args) {
		int[] array = { 1, 5, 2, 6, 3, 7, 4 };
		int[][] commands = { array, { 2, 5, 3 } };
		// System.out.println(commands[0][0]);
		// System.out.println(commands[1][0]);
	}
