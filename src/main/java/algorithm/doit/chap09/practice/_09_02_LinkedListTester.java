...
public class _09_02_LinkedListTester {
	...
	public enum Menu {
		...
		RMV_CRNT("선택 노드를 삭제"), CLEAR("모든 노드를 삭제"), SEARCH_NO("번호로 검색"), SEARCH_NAME("이름으로 검색"), NEXT("출력 노드로 이동"),
		PRINT_CRNT("선택 노드를 출력"), PURGE_NO("같은 번호의 노드를 삭제"), PURGE_NAME("같은 이름의 노드를 삭제"), RETRIEVE("임의의 노드를 출력"),
		DUMP("모든 노드를 출력"), TERMINATE("종료");
