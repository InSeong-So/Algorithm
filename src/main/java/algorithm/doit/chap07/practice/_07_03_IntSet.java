...
public class _07_03_IntSet {
	...
	// 집합 s에 복사합니다.
	public void copyTo(_07_03_IntSet s) {
	...
	// 집합 s를 복사합니다.
	public void copyFrom(_07_03_IntSet s) {
	...
	// 집합 s와 같은지 확인합니다.
	public boolean equalTo(_07_03_IntSet s) {
	...
	public void unionOf(_07_03_IntSet s1, _07_03_IntSet s2) {
	...
	// ------------------------------ 연습7-3 ------------------------------//
	// 집합 s의 부분집합인가요?
	public boolean isSubsetOf(_07_03_IntSet s) {
		for (int i = 0; i < num; i++) {
			int j = 0;
			for (; j < s.num; j++)
				if (set[i] == s.set[j])
	...
	// 집합 s의 진부분집합인가요?
	public boolean isProperSubsetOf(_07_03_IntSet s) {
