package algorithm.doit.chap04.practice;
import java.util.Scanner;

class _04_01_IntStackTesterEx {
	public static void main(String[] args) {
		Scanner stdIn = new Scanner(System.in);
		_04_00_IntStack s = new _04_00_IntStack(100); // 최대 100개를 푸시할 수 있는 스택
		...
		while (true) {
			...
			case 1: // 푸시
				...
				try {
					s.push(x);
				} catch (_04_00_IntStack.OverflowIntStackException e) {
			...
			case 2: // 팝
				...
				} catch (_04_00_IntStack.EmptyIntStackException e) {
