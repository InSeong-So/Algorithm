package algorithm.doit.chap10.practice;
import java.util.Scanner;
import java.util.Comparator;
// 이진검색트리 클래스 _10_00_BinTree<K,V>의 사용 예 (comparator를 사용)

class _10_03_BinTreeTester {
	...
	public static void main(String[] args) {
		...
		_10_00_BinTree<Integer, Data> tree = new _10_00_BinTree<Integer, Data>(INT_DEC_COMP);

		//_10_00_BinTree<Integer, Data> tree = new _10_00_BinTree<Integer, Data>();
