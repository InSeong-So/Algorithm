...
public class _07_02_IntSet {
	...
	// 집합 s에 복사합니다.
	public void copyTo(_07_02_IntSet s) {
	...
	// 집합 s를 복사합니다.
	public void copyFrom(_07_02_IntSet s) {
	...
	// 집합 s와 같은지 확인합니다.
	public boolean equalTo(_07_02_IntSet s) {
	...
	public void unionOf(_07_02_IntSet s1, _07_02_IntSet s2) {
	...
	// ------------------------------ 연습 7-2 ------------------------------//
	// 집합 s와 합집합
	public boolean add(_07_02_IntSet s) {
		boolean flag = false;
		for (int i = 0; i < num; i++)
			if (add(set[i]) == true)
				flag = true;
	...
	// 집합 s와 교집합
	public boolean retain(_07_02_IntSet s) {
		boolean flag = false;
		for (int i = 0; i < num; i++)
	...
	// 집합 s와 차집합
	public boolean remove(_07_02_IntSet s) {
		boolean flag = false;
		for (int i = 0; i < num; i++)
