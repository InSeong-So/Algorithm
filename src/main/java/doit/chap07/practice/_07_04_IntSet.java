...
public class _07_04_IntSet {
	...
	// 집합 s에 복사합니다.
	public void copyTo(_07_04_IntSet s) {
	...
	// 집합 s를 복사합니다.
	public void copyFrom(_07_04_IntSet s) {
	...
	// 집합 s와 같은지 확인합니다.
	public boolean equalTo(_07_04_IntSet s) {
	...
	public void unionOf(_07_04_IntSet s1, _07_04_IntSet s2) {
	...
	// ------------------------------ 연습7-4 ------------------------------//
	// 집합 s1과 s2의 교집합을 복사
	public void intersectionOf(_07_04_IntSet s1, _07_04_IntSet s2) {
		clear();
	...
	// 집합 s1과 s2의 차집합을 복사
	public void differenceOf(_07_04_IntSet s1, _07_04_IntSet s2) {
		clear();
		for (int i = 0; i < s1.num; i++)
			if (!s2.contains(s1.set[i]))
				add(s1.set[i]);
