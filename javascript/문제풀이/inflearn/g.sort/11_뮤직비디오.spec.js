...
function solution(m, songs) {
  // 주어진 원소의 가장 큰 값이 left, 원소를 전부 합한 값이 right가 된다.
  // 최소 용량을 찾는 것이므로 이분탐색을 돌면서 right 원소들을 제외하면 된다.
  // 9 + 45   // 27
  // 9 + 26   // 17
  let answer;
  ...
  // 결정 알고리즘은 답이 유효한지를 확인하는 것이 가장 중요하다.
  function count(songs, size) {
    let cnt = 1;
    let sum = 0;
 ...
 * ========================================================
 * @Title       : 11_뮤직비디오
 * @Path        : javascript\02_Solved\inflearn\g.sortingANDgreedANDdecision\11_뮤직비디오.spec.js
 * @Description :
 * @Date        : 2021-07-12 22:05:09
 * --------------------------------------------------------
